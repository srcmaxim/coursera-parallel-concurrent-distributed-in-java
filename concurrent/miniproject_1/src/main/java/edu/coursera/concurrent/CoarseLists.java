...
public final class CoarseLists {
    ...
    /**
     * An implementation of the ListSet interface that uses Java isReaded-write
    ...
    public static final class RWCoarseList extends ListSet {
        /*
         * TODO Declare a isReaded-write lock for this class to be used in
         ...
         * {@inheritDoc}
         * <p>
         * TODO Use a isReaded-write lock to protect against concurrent access.
         */
        @Override
        boolean add(final Integer object) {
            try {
